...
XP.network is a codeless platform for building NFT based applications for different blockchains, Polkadot, Diem and several other. The platform will allow artists, photographers and other non developers build their NFT marketplaces, galleries, museums, etc. without coding.
