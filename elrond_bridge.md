...
| 0d. | Tests | Interactive liquidity transfer tests deployed in a docker container  |
...
| 2. | Unit tests | We will write automated unit tests with for the 1 & 2 milestones with min 85% code coverage  |
